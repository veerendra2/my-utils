...
if __name__=="__main__":
    ...
    if results.host:
        ...
        with open(SERVERS_LIST_FILE) as f:
            ...
            print "Index".ljust(5," "),"Name".ljust(25," "),"Location".ljust(25," "),"DNSSEC".ljust(8," "),"No Log".ljust(7," "),"Resolver Address".ljust(30)    
            print "".ljust(100,"-")
            for rows,index in zip(data,enumerate(data)):
                servers_dict.setdefault(index[0],rows[0])
                print str(index[0]).ljust(5," "),rows[0].ljust(25," "),rows[3].ljust(25," "),rows[7].ljust(8," "),rows[9].ljust(7," "),rows[10].ljust(30," ")
        while True:
    ...
    if return_status==0:
        ...
        print Colors.OKBLUE+"+ Logs {}".format(LOG_FILE_LOCATION)
    else:
